...
class DevelopmentConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = "mysql+pymysql://reza:pmnP_AkjWk26x2020@pusakha.id/db_data_jatim"
...
class TestingConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = "mysql+pymysql://reza:pmnP_AkjWk26x2020@pusakha.id/db_data_jatim_test"
